...
license: MIT
summary: "Index of structural formatting checks for cookbook artifacts — principles, guidelines, ingredients, recipes, and concoctions."
platforms: []
tags:
  - compliance
  - artifact-formatting
...
Structural formatting checks for cookbook artifacts. Each artifact type (principle, guideline, ingredient, recipe, concoction) has its own set of checks defining the required sections, ordering, and content rules. These checks are the authoritative spec that `/lint-artifact` and `/approve-artifact` evaluate against.
...
| Concoction Formatting | [concoction-formatting.md](concoction-formatting.md) | 10 | Required structure for concoction manifests (JSON) |
