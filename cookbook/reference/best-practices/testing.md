...
title: "Testing"
domain: agenticdevelopercookbook://reference/best-practices/testing
type: reference
version: 1.0.0
status: accepted
language: en
...
license: MIT
summary: "- [Google SWE Book Ch. 11: Testing Overview](https://abseil.io/resources/swe-book/html/ch11.html)"
platforms: 
  - csharp
  - python
  - typescript
