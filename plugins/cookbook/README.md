...
Claude Code plugin shell for the Agentic Developer Cookbook.
...
1. Assembles `plugins/cookbook/skills/` by copying every directory under
   `../../skills/` into it.
...
`Skill` tool as `cookbook:<name>` and by the user as the `/cookbook:<name>`
slash command.
